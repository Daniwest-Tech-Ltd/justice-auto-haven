        ...
        <div className="space-y-6 text-foreground/90">
          <section>
            ...
            <p className="leading-relaxed">
              Cookies are small text files that are placed on your computer or mobile device when you visit a website. They are widely used to make websites work more efficiently and provide information to website owners. Cookies help us understand how you use our platform and improve your experience.
            </p>
          </section>
          ...
          <section>
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="leading-relaxed">
                  These cookies are necessary for the website to function properly. They enable basic functions like page navigation, secure area access, and authentication. The website cannot function properly without these cookies.
                </p>
              </div>
              ...
              <div>
                <h3 className="text-xl font-semibold mb-2 text-foreground">Targeting/Advertising Cookies</h3>
                <p className="leading-relaxed">
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 ml-4">
              ...
              <li>Using browser add-ons that block cookies</li>
            </ul>
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4 text-foreground">6. Browser-Specific Instructions</h2>
            <p className="leading-relaxed mb-3">
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4 text-foreground">7. Cookie Duration</h2>
            <p className="leading-relaxed">
              Cookies can be "session" cookies or "persistent" cookies. Session cookies are deleted when you close your browser, while persistent cookies remain on your device for a set period or until you delete them. The duration of our cookies varies depending on their purpose.
            </p>
          </section>
