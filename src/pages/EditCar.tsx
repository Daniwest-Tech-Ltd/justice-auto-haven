...
const EditCar = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    units_available: "" as string | number,
  });
    ...
    try {
      ...
      if (data) {
        setFormData({
          ...
          units_available: (data as any).units_available ?? "",
        });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const { error: updateError } = await supabase
        ...
        .update({
          ...formData,
          units_available: formData.units_available === "" || formData.units_available === null
            ? null
            : parseInt(String(formData.units_available)),
      ...
      if (!uploadComplete) setUploading(false);
    }
  };
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="mt-4">
              ...
              <p className="text-xs text-muted-foreground mt-1">
                If set, customers see "Available (5)" in stock on the frontend.
              </p>
            </div>
            ...
            <StockUploadAnimation isUploading={uploading} isComplete={uploadComplete} />
                ...
                style={{
                  backgroundColor: uploadComplete
                    ...
                    : uploading
                      ? "hsl(200, 75%, 50%)"
                      : undefined,
                  animation: uploading ? "heartbeat 1s ease-in-out infinite" : undefined,
                }}
              >
                {uploadComplete ? "✓ Vehicle Updated!" : uploading ? "Updating..." : "Update Vehicle"}
              </Button>
              <Button
                type="button"
                variant="outline"
