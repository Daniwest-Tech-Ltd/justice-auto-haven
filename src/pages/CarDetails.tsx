        ...
        <div className="grid gap-8 lg:gap-12 lg:grid-cols-12 mb-20">
          ...
          <div className="lg:col-span-4 space-y-6 sm:space-y-8">
            ...
            <div className="flex flex-col gap-3 sm:gap-4">
              <Button
                className="w-full h-12 sm:h-14 bg-[#25D366] hover:bg-[#20ba54] text-white font-black text-[10px] sm:text-[12px] uppercase tracking-widest rounded-lg flex items-center justify-center gap-2 sm:gap-3 border-none shadow-md transition-all whitespace-normal text-center py-2"
                asChild
              >
