            ...
            <div className="flex flex-col sm:flex-row items-center gap-8">
              ...
              <div className="flex flex-col items-center lg:items-end">
                <p className="text-[10px] font-black uppercase tracking-widest text-muted-foreground/60 mb-1 italic flex items-center gap-1">
                   <Globe className="h-2.5 w-2.5" /> Powered by My World Africa
                </p>
                <div className="flex items-center gap-3">
                  <a href="https://myworldafric.vercel.app" target="_blank" rel="noopener noreferrer" className="group">
                     <p className="text-[11px] font-black text-foreground hover:text-brand-red transition-colors uppercase tracking-widest italic">My World Africa</p>
                     <div className="h-0.5 w-0 group-hover:w-full bg-brand-red transition-all duration-500" />
                  </a>
                  <a href="https://github.com/maishdan" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-foreground transition-colors" title="GitHub">
                    <svg
